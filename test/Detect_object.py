            ...
            #  B---C
                ...
                if len(approx) == 4:
                    ...
                    if AB - AD > self.rectangle_thresh and CD - AD > self.rectangle_thresh:
                        shape_type = "矩形"
                    elif angle_AB_CD < np.pi/18 and angle_AB_AD >np.pi/1.83:##98.3
                        shape_type = "上梯形"
                    elif angle_AB_CD < np.pi/18 and angle_AB_AD < np.pi/2.25 :###80
                        shape_type = "下梯形"
...
if __name__ == '__main__':
    ...
    #img = cv2.imread("D:/table/berryPI/photo/10.jpg")  # test image
    capture_frame()
    cv2.waitKey(1)
